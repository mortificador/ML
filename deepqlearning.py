# Code taken from https://github.com/ageron/handson-ml/blob/master/16_reinforcement_learning.ipynb
# and small modifications made to it
...
def play(percent):
    ...
    for step in range(n_max_steps):
        ...
        if done:
            ...
            name = f"box_learning_{percent}_percent.mp4"
